...
const TodoList = () => {
  ...
  const [currentDateTime, setCurrentDateTime] = useState(new Date()); // Holds the current date and time
  ...
  return (
    ...
    <div className="container">
      ...
      <div className="todo-app">
         <h2>
      <img src={todoImage} alt="Todo List" /> Todo List </h2><br>
      </br><h3>
      <p style={{ fontWeight: 'bold', textAlign: 'center' }}>{currentDateTime.toLocaleString()}</p> {/* Display current date and time */}
    </h3>
...
<footer>
 <p>
    Connect with me on:
    <a href="https://www.linkedin.com/in/akashr2607">
      <FaLinkedin /> 
    </a>
  ...
  <button
    onClick={() => window.open("https://www.buymeacoffee.com/akash26007", "_blank")}
    style={{ height: '60px', width: '217px', padding: 0, border: 'none', backgroundColor: 'transparent' }}
  >
    <img
